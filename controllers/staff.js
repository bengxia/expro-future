...
exports.findAll = function(req,res,next){
    if(req.accepts('html')) {
        res.render('staff/index', {queryInput:queryInput});
    }else{
        console.log("staff - 获取所有商品信息。。。");
...
//                    console.log('jsonStr:'+jsonStr);
        ...
        function findMembersByRoleAndOrg(org_id){
            where += " and org_id = "+org_id + " and role_id in (1,2,3) ";
            //判断当前请求的是客户端还是web端
...
exports.pageView = function(req, res, next) {
    ...
    try {
        ...
        res.render('staff/staff', { layout: false, _id:_id, pageState:pageState});
    }catch(e){
