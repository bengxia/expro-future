...
function OssClient (options) {
    this._accessId = config.oss.accessId;
    this._accessKey = config.oss.accessKey;
//    this._host = "storage.aliyun.com";
//    this._port = "8080";
//    this._timeout = 30000000;
    this._host = config.oss.host;
    this._port = config.oss.port;
    this._timeout = config.oss.timeout;
};
